...
export default function SectionTitle({text1, text2, text3}: ISectionTitle) {
  return (
    <div className="p-2 flex justify-center items-center flex-col gap-4">
      <p className="px-8 py-2 border border-amber-600 bg-amber-700/40 rounded-full text-orange-400">{text1}</p>
